...
ActiveRecord::Schema[8.1].define(version: 2026_01_11_084842) do
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.check_constraint "rating >= 1 AND rating <= 5", name: "ratings_rating_between_1_and_5"
  end
  ...
  add_foreign_key "ratings", "recipes", on_delete: :cascade
